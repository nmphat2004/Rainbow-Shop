			...
			<div className='w-full md:w-1/2 flex flex-col justify-center items-center p-8 md:p-12'>
				<form
					...
					<div className='flex justify-center mb-6'>
						<h2 className='text-xl font-medium dark:text-white'>Rainbow</h2>
					</div>
					<h2 className='text-2xl font-bold text-center mb-6 dark:text-white'>Hey there!👋🏻</h2>
					...
					<div className='mb-4'>
						...
						<input
							...
							className='w-full p-2 border rounded dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200 dark:placeholder-gray-400'
					...
					<button
						className='w-full bg-black text-white dark:bg-white dark:text-black p-2 rounded-lg font-semibold hover:bg-gray-800 dark:hover:bg-gray-200 transition'
						type='submit'>
